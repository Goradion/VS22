...
#ifndef SOAP_TYPE_ns1__receiveSoapableMessageResponse_DEFINED
#define SOAP_TYPE_ns1__receiveSoapableMessageResponse_DEFINED
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__receiveSoapableMessageResponse(struct soap*, const char*, int, const ns1__receiveSoapableMessageResponse *, const char*);
SOAP_FMAC3 ns1__receiveSoapableMessageResponse * SOAP_FMAC4 soap_in_ns1__receiveSoapableMessageResponse(struct soap*, const char*, ns1__receiveSoapableMessageResponse *, const char*);
SOAP_FMAC1 ns1__receiveSoapableMessageResponse * SOAP_FMAC2 soap_instantiate_ns1__receiveSoapableMessageResponse(struct soap*, int, const char*, const char*, size_t*);

inline ns1__receiveSoapableMessageResponse * soap_new_ns1__receiveSoapableMessageResponse(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns1__receiveSoapableMessageResponse(soap, n, NULL, NULL, NULL);
}

inline ns1__receiveSoapableMessageResponse * soap_new_req_ns1__receiveSoapableMessageResponse(
	struct soap *soap)
{
	ns1__receiveSoapableMessageResponse *_p = soap_new_ns1__receiveSoapableMessageResponse(soap);
	if (_p)
	{	_p->soap_default(soap);
	}
	return _p;
...
inline ns1__receiveSoapableMessageResponse * soap_new_set_ns1__receiveSoapableMessageResponse(
	struct soap *soap,
	char *return_)
{
	ns1__receiveSoapableMessageResponse *_p = soap_new_ns1__receiveSoapableMessageResponse(soap);
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__receiveSoapableMessageResponse::return_ = return_;
	}
	return _p;
}

inline int soap_write_ns1__receiveSoapableMessageResponse(struct soap *soap, ns1__receiveSoapableMessageResponse const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:receiveSoapableMessageResponse", p->soap_type() == SOAP_TYPE_ns1__receiveSoapableMessageResponse ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns1__receiveSoapableMessageResponse(struct soap *soap, const char *URL, ns1__receiveSoapableMessageResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:receiveSoapableMessageResponse", p->soap_type() == SOAP_TYPE_ns1__receiveSoapableMessageResponse ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send_ns1__receiveSoapableMessageResponse(struct soap *soap, const char *URL, ns1__receiveSoapableMessageResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:receiveSoapableMessageResponse", p->soap_type() == SOAP_TYPE_ns1__receiveSoapableMessageResponse ? "" : NULL) || soap_end_send(soap))
		return soap->error;
...
SOAP_FMAC3 ns1__receiveSoapableMessageResponse * SOAP_FMAC4 soap_get_ns1__receiveSoapableMessageResponse(struct soap*, ns1__receiveSoapableMessageResponse *, const char*, const char*);

inline int soap_read_ns1__receiveSoapableMessageResponse(struct soap *soap, ns1__receiveSoapableMessageResponse *p)
{
	if (p)
	{	p->soap_default(soap);
		if (soap_begin_recv(soap) || soap_get_ns1__receiveSoapableMessageResponse(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns1__receiveSoapableMessageResponse(struct soap *soap, const char *URL, ns1__receiveSoapableMessageResponse *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns1__receiveSoapableMessageResponse(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv_ns1__receiveSoapableMessageResponse(struct soap *soap, ns1__receiveSoapableMessageResponse *p)
{
	if (soap_read_ns1__receiveSoapableMessageResponse(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif

#ifndef SOAP_TYPE_ns1__soapableMessage_DEFINED
#define SOAP_TYPE_ns1__soapableMessage_DEFINED
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__soapableMessage(struct soap*, const char*, int, const ns1__soapableMessage *, const char*);
SOAP_FMAC3 ns1__soapableMessage * SOAP_FMAC4 soap_in_ns1__soapableMessage(struct soap*, const char*, ns1__soapableMessage *, const char*);
SOAP_FMAC1 ns1__soapableMessage * SOAP_FMAC2 soap_instantiate_ns1__soapableMessage(struct soap*, int, const char*, const char*, size_t*);

inline ns1__soapableMessage * soap_new_ns1__soapableMessage(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns1__soapableMessage(soap, n, NULL, NULL, NULL);
}

inline ns1__soapableMessage * soap_new_req_ns1__soapableMessage(
	struct soap *soap,
	...
	int *groups)
{
	ns1__soapableMessage *_p = soap_new_ns1__soapableMessage(soap);
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__soapableMessage::serialVersionUID = serialVersionUID;
		_p->ns1__soapableMessage::messageID = messageID;
		_p->ns1__soapableMessage::userID = userID;
		_p->ns1__soapableMessage::abtNr = abtNr;
		_p->ns1__soapableMessage::oeffentlich = oeffentlich;
		_p->ns1__soapableMessage::__sizegroups = __sizegroups;
		_p->ns1__soapableMessage::groups = groups;
	}
	return _p;
}

inline ns1__soapableMessage * soap_new_set_ns1__soapableMessage(
	struct soap *soap,
	LONG64 serialVersionUID,
	int messageID,
	int userID,
	...
	time_t *time)
{
	...
	{	_p->soap_default(soap);
		...
		_p->ns1__soapableMessage::userID = userID;
		_p->ns1__soapableMessage::abtNr = abtNr;
		_p->ns1__soapableMessage::inhalt = inhalt;
		_p->ns1__soapableMessage::oeffentlich = oeffentlich;
		_p->ns1__soapableMessage::__sizegroups = __sizegroups;
		_p->ns1__soapableMessage::groups = groups;
		_p->ns1__soapableMessage::time = time;
	}
	return _p;
}

inline int soap_write_ns1__soapableMessage(struct soap *soap, ns1__soapableMessage const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:soapableMessage", p->soap_type() == SOAP_TYPE_ns1__soapableMessage ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns1__soapableMessage(struct soap *soap, const char *URL, ns1__soapableMessage const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:soapableMessage", p->soap_type() == SOAP_TYPE_ns1__soapableMessage ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send_ns1__soapableMessage(struct soap *soap, const char *URL, ns1__soapableMessage const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:soapableMessage", p->soap_type() == SOAP_TYPE_ns1__soapableMessage ? "" : NULL) || soap_end_send(soap))
		return soap->error;
...
SOAP_FMAC3 ns1__soapableMessage * SOAP_FMAC4 soap_get_ns1__soapableMessage(struct soap*, ns1__soapableMessage *, const char*, const char*);

inline int soap_read_ns1__soapableMessage(struct soap *soap, ns1__soapableMessage *p)
{
	if (p)
	{	p->soap_default(soap);
		if (soap_begin_recv(soap) || soap_get_ns1__soapableMessage(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns1__soapableMessage(struct soap *soap, const char *URL, ns1__soapableMessage *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns1__soapableMessage(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv_ns1__soapableMessage(struct soap *soap, ns1__soapableMessage *p)
{
	if (soap_read_ns1__soapableMessage(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif

#ifndef SOAP_TYPE_ns1__receiveSoapableMessage_DEFINED
#define SOAP_TYPE_ns1__receiveSoapableMessage_DEFINED
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__receiveSoapableMessage(struct soap*, const char*, int, const ns1__receiveSoapableMessage *, const char*);
SOAP_FMAC3 ns1__receiveSoapableMessage * SOAP_FMAC4 soap_in_ns1__receiveSoapableMessage(struct soap*, const char*, ns1__receiveSoapableMessage *, const char*);
SOAP_FMAC1 ns1__receiveSoapableMessage * SOAP_FMAC2 soap_instantiate_ns1__receiveSoapableMessage(struct soap*, int, const char*, const char*, size_t*);

inline ns1__receiveSoapableMessage * soap_new_ns1__receiveSoapableMessage(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns1__receiveSoapableMessage(soap, n, NULL, NULL, NULL);
}

inline ns1__receiveSoapableMessage * soap_new_req_ns1__receiveSoapableMessage(
	struct soap *soap)
{
	ns1__receiveSoapableMessage *_p = soap_new_ns1__receiveSoapableMessage(soap);
	if (_p)
	{	_p->soap_default(soap);
	}
	return _p;
...
inline ns1__receiveSoapableMessage * soap_new_set_ns1__receiveSoapableMessage(
	struct soap *soap,
	ns1__soapableMessage *arg0)
{
	...
	if (_p)
	{	_p->soap_default(soap);
		_p->ns1__receiveSoapableMessage::arg0 = arg0;
	}
	return _p;
}

inline int soap_write_ns1__receiveSoapableMessage(struct soap *soap, ns1__receiveSoapableMessage const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:receiveSoapableMessage", p->soap_type() == SOAP_TYPE_ns1__receiveSoapableMessage ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns1__receiveSoapableMessage(struct soap *soap, const char *URL, ns1__receiveSoapableMessage const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:receiveSoapableMessage", p->soap_type() == SOAP_TYPE_ns1__receiveSoapableMessage ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send_ns1__receiveSoapableMessage(struct soap *soap, const char *URL, ns1__receiveSoapableMessage const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns1:receiveSoapableMessage", p->soap_type() == SOAP_TYPE_ns1__receiveSoapableMessage ? "" : NULL) || soap_end_send(soap))
		return soap->error;
...
SOAP_FMAC3 ns1__receiveSoapableMessage * SOAP_FMAC4 soap_get_ns1__receiveSoapableMessage(struct soap*, ns1__receiveSoapableMessage *, const char*, const char*);

inline int soap_read_ns1__receiveSoapableMessage(struct soap *soap, ns1__receiveSoapableMessage *p)
{
	if (p)
	{	p->soap_default(soap);
		if (soap_begin_recv(soap) || soap_get_ns1__receiveSoapableMessage(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns1__receiveSoapableMessage(struct soap *soap, const char *URL, ns1__receiveSoapableMessage *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns1__receiveSoapableMessage(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv_ns1__receiveSoapableMessage(struct soap *soap, ns1__receiveSoapableMessage *p)
{
	if (soap_read_ns1__receiveSoapableMessage(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
#ifndef SOAP_TYPE___ns1__receiveSoapableMessage_DEFINED
#define SOAP_TYPE___ns1__receiveSoapableMessage_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__receiveSoapableMessage(struct soap*, struct __ns1__receiveSoapableMessage *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__receiveSoapableMessage(struct soap*, const struct __ns1__receiveSoapableMessage *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__receiveSoapableMessage(struct soap*, const char*, int, const struct __ns1__receiveSoapableMessage *, const char*);
SOAP_FMAC3 struct __ns1__receiveSoapableMessage * SOAP_FMAC4 soap_in___ns1__receiveSoapableMessage(struct soap*, const char*, struct __ns1__receiveSoapableMessage *, const char*);
SOAP_FMAC1 struct __ns1__receiveSoapableMessage * SOAP_FMAC2 soap_instantiate___ns1__receiveSoapableMessage(struct soap*, int, const char*, const char*, size_t*);

inline struct __ns1__receiveSoapableMessage * soap_new___ns1__receiveSoapableMessage(struct soap *soap, int n = -1)
{
	return soap_instantiate___ns1__receiveSoapableMessage(soap, n, NULL, NULL, NULL);
}

inline struct __ns1__receiveSoapableMessage * soap_new_req___ns1__receiveSoapableMessage(
	struct soap *soap)
{
	struct __ns1__receiveSoapableMessage *_p = soap_new___ns1__receiveSoapableMessage(soap);
	if (_p)
	{	soap_default___ns1__receiveSoapableMessage(soap, _p);
	}
	return _p;
}

inline struct __ns1__receiveSoapableMessage * soap_new_set___ns1__receiveSoapableMessage(
	struct soap *soap,
	ns1__receiveSoapableMessage *ns1__receiveSoapableMessage_)
{
	...
	if (_p)
	{	soap_default___ns1__receiveSoapableMessage(soap, _p);
		_p->ns1__receiveSoapableMessage_ = ns1__receiveSoapableMessage_;
	}
	return _p;
}
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__receiveSoapableMessage(struct soap*, const struct __ns1__receiveSoapableMessage *, const char*, const char*);

inline int soap_write___ns1__receiveSoapableMessage(struct soap *soap, struct __ns1__receiveSoapableMessage const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (soap_serialize___ns1__receiveSoapableMessage(soap, p), 0) || soap_put___ns1__receiveSoapableMessage(soap, p, "-ns1:receiveSoapableMessage", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT___ns1__receiveSoapableMessage(struct soap *soap, const char *URL, struct __ns1__receiveSoapableMessage const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize___ns1__receiveSoapableMessage(soap, p), 0) || soap_put___ns1__receiveSoapableMessage(soap, p, "-ns1:receiveSoapableMessage", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send___ns1__receiveSoapableMessage(struct soap *soap, const char *URL, struct __ns1__receiveSoapableMessage const*p)
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize___ns1__receiveSoapableMessage(soap, p), 0) || soap_put___ns1__receiveSoapableMessage(soap, p, "-ns1:receiveSoapableMessage", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
SOAP_FMAC3 struct __ns1__receiveSoapableMessage * SOAP_FMAC4 soap_get___ns1__receiveSoapableMessage(struct soap*, struct __ns1__receiveSoapableMessage *, const char*, const char*);

inline int soap_read___ns1__receiveSoapableMessage(struct soap *soap, struct __ns1__receiveSoapableMessage *p)
{
	if (p)
	{	soap_default___ns1__receiveSoapableMessage(soap, p);
		if (soap_begin_recv(soap) || soap_get___ns1__receiveSoapableMessage(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET___ns1__receiveSoapableMessage(struct soap *soap, const char *URL, struct __ns1__receiveSoapableMessage *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read___ns1__receiveSoapableMessage(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv___ns1__receiveSoapableMessage(struct soap *soap, struct __ns1__receiveSoapableMessage *p)
{
	if (soap_read___ns1__receiveSoapableMessage(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
#ifndef SOAP_TYPE_PointerTons1__receiveSoapableMessage_DEFINED
#define SOAP_TYPE_PointerTons1__receiveSoapableMessage_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons1__receiveSoapableMessage(struct soap*, ns1__receiveSoapableMessage *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons1__receiveSoapableMessage(struct soap*, const char *, int, ns1__receiveSoapableMessage *const*, const char *);
SOAP_FMAC3 ns1__receiveSoapableMessage ** SOAP_FMAC4 soap_in_PointerTons1__receiveSoapableMessage(struct soap*, const char*, ns1__receiveSoapableMessage **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons1__receiveSoapableMessage(struct soap*, ns1__receiveSoapableMessage *const*, const char*, const char*);
SOAP_FMAC3 ns1__receiveSoapableMessage ** SOAP_FMAC4 soap_get_PointerTons1__receiveSoapableMessage(struct soap*, ns1__receiveSoapableMessage **, const char*, const char*);
#endif
...
#ifndef SOAP_TYPE_PointerTons1__soapableMessage_DEFINED
#define SOAP_TYPE_PointerTons1__soapableMessage_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons1__soapableMessage(struct soap*, ns1__soapableMessage *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons1__soapableMessage(struct soap*, const char *, int, ns1__soapableMessage *const*, const char *);
SOAP_FMAC3 ns1__soapableMessage ** SOAP_FMAC4 soap_in_PointerTons1__soapableMessage(struct soap*, const char*, ns1__soapableMessage **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons1__soapableMessage(struct soap*, ns1__soapableMessage *const*, const char*, const char*);
SOAP_FMAC3 ns1__soapableMessage ** SOAP_FMAC4 soap_get_PointerTons1__soapableMessage(struct soap*, ns1__soapableMessage **, const char*, const char*);
#endif
