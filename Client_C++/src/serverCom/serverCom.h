...
@note HINTS:
 - Run soapcpp2 on C:\GIT\VS22\Client_C++\src\serverCom\serverCom.h to generate the SOAP/XML processing logic.
...
//  Forward declaration of class ns1__deleteMessageCorba.
class ns1__deleteMessageCorba;

//  Forward declaration of class ns1__deleteMessageCorbaResponse.
class ns1__deleteMessageCorbaResponse;

//  Forward declaration of class ns1__modifyMessageCorba.
class ns1__modifyMessageCorba;

//  Forward declaration of class ns1__modifyMessageCorbaResponse.
class ns1__modifyMessageCorbaResponse;

//  Forward declaration of class ns1__receiveMessageCorba.
class ns1__receiveMessageCorba;

//  Forward declaration of class ns1__receiveMessageCorbaResponse.
class ns1__receiveMessageCorbaResponse;
...
/// @brief "http://webservice.tafelServer/":deleteMessageCorba is a complexType.
///
/// class ns1__deleteMessageCorba operations:
/// - ns1__deleteMessageCorba* soap_new_ns1__deleteMessageCorba(soap*) allocate and default initialize
/// - ns1__deleteMessageCorba* soap_new_ns1__deleteMessageCorba(soap*, int num) allocate array and default initialize values
/// - ns1__deleteMessageCorba* soap_new_req_ns1__deleteMessageCorba(soap*, ...) allocate, set required members
/// - ns1__deleteMessageCorba* soap_new_set_ns1__deleteMessageCorba(soap*, ...) allocate, set all public members
/// - ns1__deleteMessageCorba::soap_default(soap*) default initialize members
/// - int soap_read_ns1__deleteMessageCorba(soap*, ns1__deleteMessageCorba*) deserialize from a stream
/// - int soap_write_ns1__deleteMessageCorba(soap*, ns1__deleteMessageCorba*) serialize to a stream
/// - ns1__deleteMessageCorba* ns1__deleteMessageCorba::soap_dup(soap*) returns deep copy of ns1__deleteMessageCorba, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns1__deleteMessageCorba::soap_del() deep deletes ns1__deleteMessageCorba data members, use only after ns1__deleteMessageCorba::soap_dup(NULL) (use soapcpp2 -Ed)
class ns1__deleteMessageCorba
{ public:
/// Element "arg0" of XSD type xs:int.
    int                                  arg0                           1;	///< Required element.
...
/// @brief "http://webservice.tafelServer/":deleteMessageCorbaResponse is a complexType.
///
/// class ns1__deleteMessageCorbaResponse operations:
/// - ns1__deleteMessageCorbaResponse* soap_new_ns1__deleteMessageCorbaResponse(soap*) allocate and default initialize
/// - ns1__deleteMessageCorbaResponse* soap_new_ns1__deleteMessageCorbaResponse(soap*, int num) allocate array and default initialize values
/// - ns1__deleteMessageCorbaResponse* soap_new_req_ns1__deleteMessageCorbaResponse(soap*, ...) allocate, set required members
/// - ns1__deleteMessageCorbaResponse* soap_new_set_ns1__deleteMessageCorbaResponse(soap*, ...) allocate, set all public members
/// - ns1__deleteMessageCorbaResponse::soap_default(soap*) default initialize members
/// - int soap_read_ns1__deleteMessageCorbaResponse(soap*, ns1__deleteMessageCorbaResponse*) deserialize from a stream
/// - int soap_write_ns1__deleteMessageCorbaResponse(soap*, ns1__deleteMessageCorbaResponse*) serialize to a stream
/// - ns1__deleteMessageCorbaResponse* ns1__deleteMessageCorbaResponse::soap_dup(soap*) returns deep copy of ns1__deleteMessageCorbaResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns1__deleteMessageCorbaResponse::soap_del() deep deletes ns1__deleteMessageCorbaResponse data members, use only after ns1__deleteMessageCorbaResponse::soap_dup(NULL) (use soapcpp2 -Ed)
class ns1__deleteMessageCorbaResponse
{ public:
/// Element "return" of XSD type xs:string.
    char*                                return_                        0;	///< Optional element.
...
/// @brief "http://webservice.tafelServer/":modifyMessageCorba is a complexType.
///
/// class ns1__modifyMessageCorba operations:
/// - ns1__modifyMessageCorba* soap_new_ns1__modifyMessageCorba(soap*) allocate and default initialize
/// - ns1__modifyMessageCorba* soap_new_ns1__modifyMessageCorba(soap*, int num) allocate array and default initialize values
/// - ns1__modifyMessageCorba* soap_new_req_ns1__modifyMessageCorba(soap*, ...) allocate, set required members
/// - ns1__modifyMessageCorba* soap_new_set_ns1__modifyMessageCorba(soap*, ...) allocate, set all public members
/// - ns1__modifyMessageCorba::soap_default(soap*) default initialize members
/// - int soap_read_ns1__modifyMessageCorba(soap*, ns1__modifyMessageCorba*) deserialize from a stream
/// - int soap_write_ns1__modifyMessageCorba(soap*, ns1__modifyMessageCorba*) serialize to a stream
/// - ns1__modifyMessageCorba* ns1__modifyMessageCorba::soap_dup(soap*) returns deep copy of ns1__modifyMessageCorba, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns1__modifyMessageCorba::soap_del() deep deletes ns1__modifyMessageCorba data members, use only after ns1__modifyMessageCorba::soap_dup(NULL) (use soapcpp2 -Ed)
class ns1__modifyMessageCorba
{ public:
/// Element "arg0" of XSD type xs:int.
    int                                  arg0                           1;	///< Required element.
...
/// @brief "http://webservice.tafelServer/":modifyMessageCorbaResponse is a complexType.
///
/// class ns1__modifyMessageCorbaResponse operations:
/// - ns1__modifyMessageCorbaResponse* soap_new_ns1__modifyMessageCorbaResponse(soap*) allocate and default initialize
/// - ns1__modifyMessageCorbaResponse* soap_new_ns1__modifyMessageCorbaResponse(soap*, int num) allocate array and default initialize values
/// - ns1__modifyMessageCorbaResponse* soap_new_req_ns1__modifyMessageCorbaResponse(soap*, ...) allocate, set required members
/// - ns1__modifyMessageCorbaResponse* soap_new_set_ns1__modifyMessageCorbaResponse(soap*, ...) allocate, set all public members
/// - ns1__modifyMessageCorbaResponse::soap_default(soap*) default initialize members
/// - int soap_read_ns1__modifyMessageCorbaResponse(soap*, ns1__modifyMessageCorbaResponse*) deserialize from a stream
/// - int soap_write_ns1__modifyMessageCorbaResponse(soap*, ns1__modifyMessageCorbaResponse*) serialize to a stream
/// - ns1__modifyMessageCorbaResponse* ns1__modifyMessageCorbaResponse::soap_dup(soap*) returns deep copy of ns1__modifyMessageCorbaResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns1__modifyMessageCorbaResponse::soap_del() deep deletes ns1__modifyMessageCorbaResponse data members, use only after ns1__modifyMessageCorbaResponse::soap_dup(NULL) (use soapcpp2 -Ed)
class ns1__modifyMessageCorbaResponse
{ public:
/// Element "return" of XSD type xs:string.
    char*                                return_                        0;	///< Optional element.
...
/// @brief "http://webservice.tafelServer/":receiveMessageCorba is a complexType.
///
/// class ns1__receiveMessageCorba operations:
/// - ns1__receiveMessageCorba* soap_new_ns1__receiveMessageCorba(soap*) allocate and default initialize
/// - ns1__receiveMessageCorba* soap_new_ns1__receiveMessageCorba(soap*, int num) allocate array and default initialize values
/// - ns1__receiveMessageCorba* soap_new_req_ns1__receiveMessageCorba(soap*, ...) allocate, set required members
/// - ns1__receiveMessageCorba* soap_new_set_ns1__receiveMessageCorba(soap*, ...) allocate, set all public members
/// - ns1__receiveMessageCorba::soap_default(soap*) default initialize members
/// - int soap_read_ns1__receiveMessageCorba(soap*, ns1__receiveMessageCorba*) deserialize from a stream
/// - int soap_write_ns1__receiveMessageCorba(soap*, ns1__receiveMessageCorba*) serialize to a stream
/// - ns1__receiveMessageCorba* ns1__receiveMessageCorba::soap_dup(soap*) returns deep copy of ns1__receiveMessageCorba, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns1__receiveMessageCorba::soap_del() deep deletes ns1__receiveMessageCorba data members, use only after ns1__receiveMessageCorba::soap_dup(NULL) (use soapcpp2 -Ed)
class ns1__receiveMessageCorba
{ public:
/// Element "arg0" of XSD type xs:int.
    int                                  arg0                           1;	///< Required element.
...
/// Element "arg4" of XSD type xs:string.
    char*                                arg4                           0;	///< Optional element.
/// Element "arg5" of XSD type xs:boolean.
    bool                                 arg5                           1;	///< Required element.
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};

/// @brief "http://webservice.tafelServer/":receiveMessageCorbaResponse is a complexType.
///
/// class ns1__receiveMessageCorbaResponse operations:
/// - ns1__receiveMessageCorbaResponse* soap_new_ns1__receiveMessageCorbaResponse(soap*) allocate and default initialize
/// - ns1__receiveMessageCorbaResponse* soap_new_ns1__receiveMessageCorbaResponse(soap*, int num) allocate array and default initialize values
/// - ns1__receiveMessageCorbaResponse* soap_new_req_ns1__receiveMessageCorbaResponse(soap*, ...) allocate, set required members
/// - ns1__receiveMessageCorbaResponse* soap_new_set_ns1__receiveMessageCorbaResponse(soap*, ...) allocate, set all public members
/// - ns1__receiveMessageCorbaResponse::soap_default(soap*) default initialize members
/// - int soap_read_ns1__receiveMessageCorbaResponse(soap*, ns1__receiveMessageCorbaResponse*) deserialize from a stream
/// - int soap_write_ns1__receiveMessageCorbaResponse(soap*, ns1__receiveMessageCorbaResponse*) serialize to a stream
/// - ns1__receiveMessageCorbaResponse* ns1__receiveMessageCorbaResponse::soap_dup(soap*) returns deep copy of ns1__receiveMessageCorbaResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns1__receiveMessageCorbaResponse::soap_del() deep deletes ns1__receiveMessageCorbaResponse data members, use only after ns1__receiveMessageCorbaResponse::soap_dup(NULL) (use soapcpp2 -Ed)
class ns1__receiveMessageCorbaResponse
{ public:
/// Element "return" of XSD type xs:string.
    char*                                return_                        0;	///< Optional element.
...
/// @brief Top-level root element "http://webservice.tafelServer/":deleteMessageCorba of XSD type "http://webservice.tafelServer/":deleteMessageCorba.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "http://webservice.tafelServer/":deleteMessageCorbaResponse of XSD type "http://webservice.tafelServer/":deleteMessageCorbaResponse.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.
...
/// @brief Top-level root element "http://webservice.tafelServer/":modifyMessageCorba of XSD type "http://webservice.tafelServer/":modifyMessageCorba.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "http://webservice.tafelServer/":modifyMessageCorbaResponse of XSD type "http://webservice.tafelServer/":modifyMessageCorbaResponse.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.
...
/// @brief Top-level root element "http://webservice.tafelServer/":receiveMessageCorba of XSD type "http://webservice.tafelServer/":receiveMessageCorba.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "http://webservice.tafelServer/":receiveMessageCorbaResponse of XSD type "http://webservice.tafelServer/":receiveMessageCorbaResponse.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.
...
@section ServerComWebserviceImplPortBinding_operations Operations of Binding "ServerComWebserviceImplPortBinding"
  ...
  - @ref __ns1__receiveMessageCorba

  - @ref __ns1__deletePublicMessage

  - @ref __ns1__deleteMessageCorba

  - @ref __ns1__modifyPublicMessage

  - @ref __ns1__modifyMessageCorba
...
/** Operation "__ns1__receiveMessageCorba" of service binding "ServerComWebserviceImplPortBinding".
  ...
  - Addressing input action: "http://webservice.tafelServer/ServerComWebservice/receiveMessageCorbaRequest"

  - Addressing output action: "http://webservice.tafelServer/ServerComWebservice/receiveMessageCorbaResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__receiveMessageCorba(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    ns1__receiveMessageCorbaResponse   &ns1__receiveMessageCorbaResponse_
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__receiveMessageCorba(
    struct soap *soap,
    // input parameters:
    ns1__receiveMessageCorba*           ns1__receiveMessageCorba_,
    // output parameters:
...
//gsoap ns1  service method-protocol:	receiveMessageCorba SOAP
//gsoap ns1  service method-style:	receiveMessageCorba document
//gsoap ns1  service method-encoding:	receiveMessageCorba literal
//gsoap ns1  service method-input-action:	receiveMessageCorba http://webservice.tafelServer/ServerComWebservice/receiveMessageCorbaRequest
//gsoap ns1  service method-output-action:	receiveMessageCorba http://webservice.tafelServer/ServerComWebservice/receiveMessageCorbaResponse
int __ns1__receiveMessageCorba(
    ns1__receiveMessageCorba*           ns1__receiveMessageCorba_,	///< Input parameter
    ns1__receiveMessageCorbaResponse   &ns1__receiveMessageCorbaResponse_	///< Output parameter
);
...
/** Operation "__ns1__deleteMessageCorba" of service binding "ServerComWebserviceImplPortBinding".
  ...
  - Addressing input action: "http://webservice.tafelServer/ServerComWebservice/deleteMessageCorbaRequest"

  - Addressing output action: "http://webservice.tafelServer/ServerComWebservice/deleteMessageCorbaResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__deleteMessageCorba(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    ns1__deleteMessageCorbaResponse    &ns1__deleteMessageCorbaResponse_
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__deleteMessageCorba(
    struct soap *soap,
    // input parameters:
    ns1__deleteMessageCorba*            ns1__deleteMessageCorba_,
    // output parameters:
...
//gsoap ns1  service method-protocol:	deleteMessageCorba SOAP
//gsoap ns1  service method-style:	deleteMessageCorba document
//gsoap ns1  service method-encoding:	deleteMessageCorba literal
//gsoap ns1  service method-input-action:	deleteMessageCorba http://webservice.tafelServer/ServerComWebservice/deleteMessageCorbaRequest
//gsoap ns1  service method-output-action:	deleteMessageCorba http://webservice.tafelServer/ServerComWebservice/deleteMessageCorbaResponse
int __ns1__deleteMessageCorba(
    ns1__deleteMessageCorba*            ns1__deleteMessageCorba_,	///< Input parameter
    ns1__deleteMessageCorbaResponse    &ns1__deleteMessageCorbaResponse_	///< Output parameter
);
...
/** Operation "__ns1__modifyMessageCorba" of service binding "ServerComWebserviceImplPortBinding".
  ...
  - Addressing input action: "http://webservice.tafelServer/ServerComWebservice/modifyMessageCorbaRequest"

  - Addressing output action: "http://webservice.tafelServer/ServerComWebservice/modifyMessageCorbaResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__modifyMessageCorba(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    ns1__modifyMessageCorbaResponse    &ns1__modifyMessageCorbaResponse_
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__modifyMessageCorba(
    struct soap *soap,
    // input parameters:
    ns1__modifyMessageCorba*            ns1__modifyMessageCorba_,
    // output parameters:
...
//gsoap ns1  service method-protocol:	modifyMessageCorba SOAP
//gsoap ns1  service method-style:	modifyMessageCorba document
//gsoap ns1  service method-encoding:	modifyMessageCorba literal
//gsoap ns1  service method-input-action:	modifyMessageCorba http://webservice.tafelServer/ServerComWebservice/modifyMessageCorbaRequest
//gsoap ns1  service method-output-action:	modifyMessageCorba http://webservice.tafelServer/ServerComWebservice/modifyMessageCorbaResponse
int __ns1__modifyMessageCorba(
    ns1__modifyMessageCorba*            ns1__modifyMessageCorba_,	///< Input parameter
    ns1__modifyMessageCorbaResponse    &ns1__modifyMessageCorbaResponse_	///< Output parameter
);
...
@section ns1 Top-level root elements of schema "http://webservice.tafelServer/"
  ...
  - <ns1:deleteMessageCorba> (use wsdl2h option -g to auto-generate type _ns1__deleteMessageCorba)

  - <ns1:deleteMessageCorbaResponse> (use wsdl2h option -g to auto-generate type _ns1__deleteMessageCorbaResponse)
  ...
  - <ns1:modifyMessageCorba> (use wsdl2h option -g to auto-generate type _ns1__modifyMessageCorba)

  - <ns1:modifyMessageCorbaResponse> (use wsdl2h option -g to auto-generate type _ns1__modifyMessageCorbaResponse)
  ...
  - <ns1:receiveMessageCorba> (use wsdl2h option -g to auto-generate type _ns1__receiveMessageCorba)

  - <ns1:receiveMessageCorbaResponse> (use wsdl2h option -g to auto-generate type _ns1__receiveMessageCorbaResponse)
...
/* End of C:\GIT\VS22\Client_C++\src\serverCom\serverCom.h */
