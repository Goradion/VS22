...
//  Forward declaration of class ns1__deletePublicMessageCorba.
class ns1__deletePublicMessageCorba;

//  Forward declaration of class ns1__deletePublicMessageCorbaResponse.
class ns1__deletePublicMessageCorbaResponse;
...
/// @brief "http://webservice.tafelServer/":deletePublicMessageCorba is a complexType.
///
/// class ns1__deletePublicMessageCorba operations:
/// - ns1__deletePublicMessageCorba* soap_new_ns1__deletePublicMessageCorba(soap*) allocate and default initialize
/// - ns1__deletePublicMessageCorba* soap_new_ns1__deletePublicMessageCorba(soap*, int num) allocate array and default initialize values
/// - ns1__deletePublicMessageCorba* soap_new_req_ns1__deletePublicMessageCorba(soap*, ...) allocate, set required members
/// - ns1__deletePublicMessageCorba* soap_new_set_ns1__deletePublicMessageCorba(soap*, ...) allocate, set all public members
/// - ns1__deletePublicMessageCorba::soap_default(soap*) default initialize members
/// - int soap_read_ns1__deletePublicMessageCorba(soap*, ns1__deletePublicMessageCorba*) deserialize from a stream
/// - int soap_write_ns1__deletePublicMessageCorba(soap*, ns1__deletePublicMessageCorba*) serialize to a stream
/// - ns1__deletePublicMessageCorba* ns1__deletePublicMessageCorba::soap_dup(soap*) returns deep copy of ns1__deletePublicMessageCorba, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns1__deletePublicMessageCorba::soap_del() deep deletes ns1__deletePublicMessageCorba data members, use only after ns1__deletePublicMessageCorba::soap_dup(NULL) (use soapcpp2 -Ed)
class ns1__deletePublicMessageCorba
{ public:
/// Element "arg0" of XSD type xs:int.
    int                                  arg0                           1;	///< Required element.
...
/// @brief "http://webservice.tafelServer/":deletePublicMessageCorbaResponse is a complexType.
///
/// class ns1__deletePublicMessageCorbaResponse operations:
/// - ns1__deletePublicMessageCorbaResponse* soap_new_ns1__deletePublicMessageCorbaResponse(soap*) allocate and default initialize
/// - ns1__deletePublicMessageCorbaResponse* soap_new_ns1__deletePublicMessageCorbaResponse(soap*, int num) allocate array and default initialize values
/// - ns1__deletePublicMessageCorbaResponse* soap_new_req_ns1__deletePublicMessageCorbaResponse(soap*, ...) allocate, set required members
/// - ns1__deletePublicMessageCorbaResponse* soap_new_set_ns1__deletePublicMessageCorbaResponse(soap*, ...) allocate, set all public members
/// - ns1__deletePublicMessageCorbaResponse::soap_default(soap*) default initialize members
/// - int soap_read_ns1__deletePublicMessageCorbaResponse(soap*, ns1__deletePublicMessageCorbaResponse*) deserialize from a stream
/// - int soap_write_ns1__deletePublicMessageCorbaResponse(soap*, ns1__deletePublicMessageCorbaResponse*) serialize to a stream
/// - ns1__deletePublicMessageCorbaResponse* ns1__deletePublicMessageCorbaResponse::soap_dup(soap*) returns deep copy of ns1__deletePublicMessageCorbaResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns1__deletePublicMessageCorbaResponse::soap_del() deep deletes ns1__deletePublicMessageCorbaResponse data members, use only after ns1__deletePublicMessageCorbaResponse::soap_dup(NULL) (use soapcpp2 -Ed)
class ns1__deletePublicMessageCorbaResponse
{ public:
/// Element "return" of XSD type xs:string.
    char*                                return_                        0;	///< Optional element.
...
/// @brief Top-level root element "http://webservice.tafelServer/":deletePublicMessageCorba of XSD type "http://webservice.tafelServer/":deletePublicMessageCorba.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.

/// @brief Top-level root element "http://webservice.tafelServer/":deletePublicMessageCorbaResponse of XSD type "http://webservice.tafelServer/":deletePublicMessageCorbaResponse.
/// @note Use wsdl2h option -g to auto-generate a top-level root element declaration and processing code.
...
@section ServerComWebserviceImplPortBinding_operations Operations of Binding "ServerComWebserviceImplPortBinding"
  ...
  - @ref __ns1__deletePublicMessageCorba
...
/** Operation "__ns1__deletePublicMessageCorba" of service binding "ServerComWebserviceImplPortBinding".
  ...
  - Addressing input action: "http://webservice.tafelServer/ServerComWebservice/deletePublicMessageCorbaRequest"

  - Addressing output action: "http://webservice.tafelServer/ServerComWebservice/deletePublicMessageCorbaResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__deletePublicMessageCorba(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    ns1__deletePublicMessageCorbaResponse&ns1__deletePublicMessageCorbaResponse_
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__deletePublicMessageCorba(
    struct soap *soap,
    // input parameters:
    ns1__deletePublicMessageCorba*      ns1__deletePublicMessageCorba_,
    // output parameters:
...
//gsoap ns1  service method-protocol:	deletePublicMessageCorba SOAP
//gsoap ns1  service method-style:	deletePublicMessageCorba document
//gsoap ns1  service method-encoding:	deletePublicMessageCorba literal
//gsoap ns1  service method-input-action:	deletePublicMessageCorba http://webservice.tafelServer/ServerComWebservice/deletePublicMessageCorbaRequest
//gsoap ns1  service method-output-action:	deletePublicMessageCorba http://webservice.tafelServer/ServerComWebservice/deletePublicMessageCorbaResponse
int __ns1__deletePublicMessageCorba(
    ns1__deletePublicMessageCorba*      ns1__deletePublicMessageCorba_,	///< Input parameter
    ns1__deletePublicMessageCorbaResponse&ns1__deletePublicMessageCorbaResponse_	///< Output parameter
);
...
@section ns1 Top-level root elements of schema "http://webservice.tafelServer/"
  ...
  - <ns1:deletePublicMessageCorba> (use wsdl2h option -g to auto-generate type _ns1__deletePublicMessageCorba)

  - <ns1:deletePublicMessageCorbaResponse> (use wsdl2h option -g to auto-generate type _ns1__deletePublicMessageCorbaResponse)
