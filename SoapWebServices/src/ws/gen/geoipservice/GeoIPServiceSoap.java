...
public interface GeoIPServiceSoap {
     ...
     * @param ipAddress
     * @return
     *     returns ws.gen.geoipservice.GeoIP
     */
    ...
    @RequestWrapper(localName = "GetGeoIP", targetNamespace = "http://www.webservicex.net/", className = "ws.gen.geoipservice.GetGeoIP")
    @ResponseWrapper(localName = "GetGeoIPResponse", targetNamespace = "http://www.webservicex.net/", className = "ws.gen.geoipservice.GetGeoIPResponse")
    ...
    @RequestWrapper(localName = "GetGeoIPContext", targetNamespace = "http://www.webservicex.net/", className = "ws.gen.geoipservice.GetGeoIPContext")
    @ResponseWrapper(localName = "GetGeoIPContextResponse", targetNamespace = "http://www.webservicex.net/", className = "ws.gen.geoipservice.GetGeoIPContextResponse")
