...
public class Client {
   ...
   private static List<Message> msgs;
	...
	public static void main(String[] args) {
		...
		msgs.add(new Message("Noch eine Nachricht die wirklich sehr lang sein soll lkjsdfioasopekpoaiksg�okaosdgk�adskglkasdf�pgk�sdkfglkad�ofgk�oadkfgopake�rgkaeokegopaklerohka�sdgjlisr�tlrg�pylkd�ogijlsdykfgkl�x��tkh�ox�fz�j�oxflh�x�fl�ph�Xrtu ENDE DER NACHTICHT",1,2,false,1));
...
//		}
	...
	//TODO Nachricht �ndern und speichern
		clientGui.showShowMessages(msgs);
