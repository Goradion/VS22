...
abstract public class MessageDataHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[4] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (corbaConnect.MessageDataHelper.id (), "MessageData", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    corbaConnect.MessageData value = new corbaConnect.MessageData ();
